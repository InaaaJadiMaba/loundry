...
$query = "SELECT transaksi.*,transaksi.kode_invoice, member.id_member,member.nama_member outlet.id_outlet, outlet.nama_outlet paket.id_paket, paket.nama_paket FROM paket INNER JOIN outlet ON outlet.id_outlet = transaksi.outlet_id INNER JOIN member ON member.id_member = transaksi.member_id";
...
if(isset($_POST['btn-simpan'])){
    ...
    $query = "INSERT INTO transaksi () values ('$nama', '$username', '$pass', '$role','$outlet_id')";
        ...
        <div class="col-md-12 col-lg-12 col-sm-12 col-xs-12">
            <div class="white-box">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="kode_invoice" class="form-control" readonly="" value="DRY202311060421">
                </div>
                <div class="form-group">
                    <label>Outlet</label>
                    <input type="text" name="username" class="form-control" readonly="" value="Londre Cab. Mampang Prapatan">
                </div>
                <div class="form-group">
