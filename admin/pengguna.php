                    ...
                    <table class="table table-bordered thead-dark" id="table">
                        ...
                        <?php foreach($data as $user): ?>
                                <tr>
                                    ...
                                    <a href="pengguna_edit.php?id=<?= htmlspecialchars($user['id_user']);?>" data-toggle="tooltip" data-placement="bottom" title="Edit" class="btn btn-success"><i class="fa fa-edit"></i></a>
                                    <a href="pengguna_hapus.php?id=<?= htmlspecialchars($user['id_user']);?>" onclick="return confirm('Yakin hapus data?');"  data-toggle="tooltip" data-placement="bottom" title="Hapus" class="btn btn-danger"><i class="fa fa-trash"></i></a>
                                    </td>
                                </tr>
                            <?php endforeach; ?>                        
                                                    </tbody>
