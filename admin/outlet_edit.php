...
if(isset($_POST['btn-simpan'])){
    $nama =stripcslashes ($_POST['nama_outlet']);
    $alamat =stripcslashes ($_POST['alamat_outlet']);
    $telp =stripcslashes ($_POST['telp_outlet']);
    ...
    if($_POST['owner_id_new']){
        ...
        $query3 = "UPDATE user SET outlet_id = NULL WHERE id_user = " .stripslashes($_GET['id']);
        ...
        <div class="col-md-12 col-lg-12 col-sm-12 col-xs-12">
            <div class="white-box">
                ...
                <?php if($data['nama_user'] ==null): ?>
                    ...
                    <?php else: ?>
                        <div class="form-group">
                            <label>Owner Sekarang: <?= htmlspecialchars($data['nama_user']); ?>(silahkan pilih owner)</label>
