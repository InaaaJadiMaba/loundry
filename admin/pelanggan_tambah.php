...
$member = ambildata($conn,'SELECT * FROM member');
...
if(isset($_POST['btn-simpan'])){
    ...
    $query = "INSERT INTO member (no_ktp,nama_member,alamat_member,telp_member,jenis_kelamin) values ('$no_ktp','$nama_member', '$alamat_member', '$telp_member', '$jenis_kelamin')";
