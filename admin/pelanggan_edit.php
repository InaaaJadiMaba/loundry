...
if(isset($_POST['btn-simpan'])){
    ...
    $query = "UPDATE member SET nama_member='$nama_member',alamat_member='$alamat_member',telp_member='$telp_member',jenis_kelamin='$jenis_kelamin' WHERE id_member='$id_member'";
        ...
        <div class="col-md-12 col-lg-12 col-sm-12 col-xs-12">
            <div class="white-box">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" value="<?=($edit['no_ktp']); ?>">
                </div>
                <div class="form-group">
